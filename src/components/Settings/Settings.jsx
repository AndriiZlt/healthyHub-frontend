...
const Settings = () => {
  return (
      ...
      <button className={css.buttonSave} type="submit">Save</button>
      </div>
      </div>
      ...
      <img className={css.download}
      src={download}
      alt="download illustration"
      ></img>
      <a href=" " className={css.link}>Download new photo</a>
      </div>
      </div>
      <div>
      ...
      <input type="radio" name="gender" variant="male" className={css.inputGender}/>
      Male
      </label>
      <label>
      <input type="radio" name="gender" variant="female" className={css.inputGender}/>
      Female
      </label>
      </div>
      <div>
      ...
      <input type="text" name="userheight" placeholder="Enter your height" 
      className={css.input}/> 
      </div>
      <div>
      ...
      <input type="text" name="userweight" placeholder="Enter your weight"
      className={css.input}/> 
      </div>
      </form>
